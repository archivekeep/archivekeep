...
data class ArchiveOperationLaunchers(
    ...
    val openDeletedFilesCleanupOperation: (repositoryURI: RepositoryURI) -> Unit,
...
val LocalArchiveOperationLaunchers =
    staticCompositionLocalOf {
        ArchiveOperationLaunchers(
            ...
            openDeletedFilesCleanupOperation = { invalidUseOfContext("openDeletedFilesCleanupOperation") },
            ...
            openDeinitializeFilesystemRepository = { _, _ -> invalidUseOfContext("openDeinitializeFilesystemRepository") },
